...
export function HubAssist({ organizationId: _organizationId }: { organizationId?: string }) {
  ...
  // The launcher is mounted once by the root layout. Keep it off public/auth entry screens,
  // where there is no authenticated workspace for the assistant to use.
