...
begin
  ...
  insert into storefronts(organization_id, status, template, theme_settings, published_at)
  values (new_org, 'published', 'editorial', '{"mode":"light","accent":"neutral","radius":"medium"}'::jsonb, now());
  return new_org;
end;
$$;
